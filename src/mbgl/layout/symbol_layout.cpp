    ...
    if (layout.get<SymbolPlacement>() == SymbolPlacementType::Line) {
        ...
        for (const auto& line : clippedLines) {
            Anchors anchors = getAnchors(line,
                                         symbolSpacing,
                                         textMaxAngle,
                                         (shapedTextOrientations.second ? shapedTextOrientations.second : shapedTextOrientations.first).left,
                                         (shapedTextOrientations.second ? shapedTextOrientations.second : shapedTextOrientations.first).right,
